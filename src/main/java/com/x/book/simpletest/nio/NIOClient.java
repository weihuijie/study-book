package com.x.book.simpletest.nio;
...
public class NIOClient {
    ...
    //1、allocate HeapByteBuffer就是创建效率高，读取和写入的效率低。
    //2、 allocateDirect  DirectByteBuffer是创建效率低，读取和写入的效率高。
    ...
    public void start() throws IOException {
        ...
        sc.connect(new InetSocketAddress("10.133.254.37",3400));
        //创建选择器
