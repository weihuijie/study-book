...
import com.x.book.Java并发编程.net.jcip.examples.DynamicOrderDeadlock.Account;
import com.x.book.Java并发编程.net.jcip.examples.DynamicOrderDeadlock.DollarAmount;
/**
 * DemonstrateDeadlock
 * <p/>
